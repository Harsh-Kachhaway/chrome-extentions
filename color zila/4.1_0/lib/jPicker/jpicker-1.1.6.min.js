(function (e, a) {
            ...
            case o && o.get(0):
              switch (E.keyCode) {
                case 38:
                  ...
                  z.val(
                    "a",
                    Math.precision((o.val() * 255) / 100, y),
                    E.target
                  );
                  return false;
                case 40:
        ...
        w = function (E) {
          ...
          switch (E.target) {
            ...
            case B && B.get(0):
              ...
              z.val(
                "a",
                B.val() != null ? parseInt(B.val(), 16) : null,
                E.target
              );
              break;
          }
      ...
      if (z) {
        if (z.ahex != null) {
          ...
          if (z.hex != null) {
            l(
              (z.a != null ? "a" : "") + "hex",
              z.a != null ? { ahex: z.hex + g.intToHex(z.a) } : z
            );
          } else {
  ...
  e.fn.jPicker = function (j) {
    ...
    return this.each(function () {
      ...
      if (e(w).get(0).nodeName.toLowerCase() == "input") {
        e.extend(true, av, {
          window: { bindToInput: true, expandable: true, input: e(w) },
        });
        if (e(w).val() == "") {
      ...
      var Q =
          ...
          if (az != D) {
            switch (av.color.mode) {
              ...
              case "a":
                ...
                D.val(
                  "xy",
                  { x: (aB && aB.h) || 0, y: 100 - (aB != null ? aB.v : 100) },
                  az
                );
                break;
              case "v":
                ...
                D.val(
                  "xy",
                  { x: (aE && aE.h) || 0, y: 100 - (aE != null ? aE.s : 100) },
                  az
                );
                break;
              case "r":
          ...
          switch (av.color.mode) {
            case "h":
              y.call(
                w,
                l,
                new f({ h: aC.val("h") || 0, s: 100, v: 100 }).val("hex")
              );
              break;
            case "s":
            case "a":
            ...
            case "r":
              Y.call(
                w,
                at,
                Math.precision(((aC.val("r") || 0) / 255) * 100, 4)
              );
              break;
            case "g":
              Y.call(
                w,
                at,
                Math.precision(((aC.val("g") || 0) / 255) * 100, 4)
              );
              break;
            case "b":
          ...
          switch (av.color.mode) {
            ...
            case "s":
              ...
              Y.call(
                w,
                L,
                Math.precision(((255 - ((aA && aA.a) || 0)) * 100) / 255, 4)
              );
              break;
            case "v":
              var aC = aF.val("hsa"),
              ...
              Y.call(
                w,
                L,
                Math.precision(((255 - ((aC && aC.a) || 0)) * 100) / 255, 4)
              );
              break;
            case "r":
            case "g":
            case "b":
              ...
              Y.call(
                w,
                O,
                aD > aG ? Math.precision(((aD - aG) / (255 - aG)) * 100, 4) : 0
              );
              Y.call(
                w,
                N,
                aG > aD ? Math.precision(((aG - aD) / (255 - aD)) * 100, 4) : 0
              );
              Y.call(w, M, Math.precision((aI / 255) * 100, 4));
              Y.call(
                w,
                L,
                Math.precision(((255 - ((az && az.a) || 0)) * 100) / 255, 4)
              );
              break;
            case "a":
              var aH = aF.val("a");
        ...
        t = function (az, aA) {
          if (
            ...
            (aA.indexOf("AlphaBar.png") != -1 ||
              aA.indexOf("Bars.png") != -1 ||
              aA.indexOf("Maps.png") != -1)
          ) {
            az.attr("pngSrc", aA);
            az.css({
            ...
            if (Q) {
              ...
              if (
                ...
                (aB.indexOf("AlphaBar.png") != -1 ||
                  aB.indexOf("Bars.png") != -1 ||
                  aB.indexOf("Maps.png") != -1)
              ) {
                aA.css({
                  filter:
                    "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" +
        ...
        A = function (az) {
          e(this)
            .parents("tbody:first")
            .find('input:radio[value!="' + az.target.value + '"]')
            .removeAttr("checked");
        ...
        o = function () {
          ...
          var aK =
            ...
            '/>B:</label><br/><br/></td><td class="Text"><input type="text" maxlength="3" value="' +
            (aJ != null ? aJ.v : "") +
            '" title="' +
            ...
            (aG.alphaSupport
              ? '<input type="text" maxlength="' +
                ...
                '" value="' +
                (aJ != null
                  ? Math.precision((aJ.a * 100) / 255, aG.alphaPrecision)
                  : "") +
                '" title="' +
          ...
          if (aG.expandable) {
            R.html(aK);
            if (
              e(document.body).children("div.jPicker.Container").length == 0
            ) {
            ...
            R.css({
              left:
                aG.position.x == "left"
                  ? az.offset().left -
                    530 -
                    (aG.position.y == "center" ? 25 : 0) +
                    "px"
                  : aG.position.x == "center"
                  ? az.offset().left - 260 + "px"
                  : aG.position.x == "right"
                  ? az.offset().left -
                    10 +
                    (aG.position.y == "center" ? 25 : 0) +
                    "px"
                  : aG.position.x == "screenCenter"
                  ? (e(document).width() >> 1) - 260 + "px"
                  : az.offset().left + parseInt(aG.position.x) + "px",
              position: "absolute",
              top:
                aG.position.y == "top"
                  ? az.offset().top - 312 + "px"
                  : aG.position.y == "center"
                  ? az.offset().top - 156 + "px"
                  : aG.position.y == "bottom"
                  ? az.offset().top + 25 + "px"
                  : az.offset().top + parseInt(aG.position.y) + "px",
            });
          } else {
            R = e(w);
            R.html(aK);
          ...
          aw = new b(
            aD,
            G.active,
            aG.expandable && aG.bindToInput ? aG.input : null,
            aG.alphaPrecision
          );
          ...
          E = aH
            .find(".Active:first")
            .css({ backgroundColor: (aB && "#" + aB) || "transparent" });
          an = aH
            .find(".Current:first")
            .css({ backgroundColor: (aB && "#" + aB) || "transparent" })
            .bind("click", Z);
          ...
          console.log(G)
          let onga = 34
          if (G.quickList && onga > 0) {
            var aE = "";
            for (i = 0; i < onga; i++) {
              if (
                (typeof G.quickList[i]).toString().toLowerCase() == "string"
              ) {
              ...
              aE +=
                ...
                (aA
                  ? ""
                  : "background-image:url(" + n.clientPath + "NoColor.png)") +
                (aG.alphaSupport && aC && aC < 255
                  ? ";opacity:" +
          ...
          if (aG.expandable) {
            ...
            Y.call(
              w,
              r,
              Math.precision(((255 - (aJ != null ? aJ.a : 0)) * 100) / 255, 4)
            );
            C = w.icon
              .find(".Image:first")
              .css({
        ...
        G = {
          active:
            (typeof av.color.active).toString().toLowerCase() == "string"
              ? new f({
                  ahex:
                    !av.window.alphaSupport && av.color.active
                      ? av.color.active.substring(0, 6) + "ff"
                      : av.color.active,
                })
              : new f({
                  ahex:
                    !av.window.alphaSupport && av.color.active.val("ahex")
                      ? av.color.active.val("ahex").substring(0, 6) + "ff"
                      : av.color.active.val("ahex"),
                }),
          current:
            (typeof av.color.active).toString().toLowerCase() == "string"
              ? new f({
  ...
  e.fn.jPicker.defaults = {
    ...
    color: {
      ...
      quickList: [
        new f({ h: 360, s: 33, v: 100 }),
        new f({ h: 360, s: 66, v: 100 }),
        new f({ h: 360, s: 100, v: 100 }),
        new f({ h: 360, s: 100, v: 75 }),
        new f({ h: 360, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 100 }),
        new f({ h: 30, s: 33, v: 100 }),
        new f({ h: 30, s: 66, v: 100 }),
        new f({ h: 30, s: 100, v: 100 }),
        new f({ h: 30, s: 100, v: 75 }),
        new f({ h: 30, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 90 }),
        new f({ h: 60, s: 33, v: 100 }),
        new f({ h: 60, s: 66, v: 100 }),
        new f({ h: 60, s: 100, v: 100 }),
        new f({ h: 60, s: 100, v: 75 }),
        new f({ h: 60, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 80 }),
        new f({ h: 90, s: 33, v: 100 }),
        new f({ h: 90, s: 66, v: 100 }),
        new f({ h: 90, s: 100, v: 100 }),
        new f({ h: 90, s: 100, v: 75 }),
        new f({ h: 90, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 70 }),
        new f({ h: 120, s: 33, v: 100 }),
        new f({ h: 120, s: 66, v: 100 }),
        new f({ h: 120, s: 100, v: 100 }),
        new f({ h: 120, s: 100, v: 75 }),
        new f({ h: 120, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 60 }),
        new f({ h: 150, s: 33, v: 100 }),
        new f({ h: 150, s: 66, v: 100 }),
        new f({ h: 150, s: 100, v: 100 }),
        new f({ h: 150, s: 100, v: 75 }),
        new f({ h: 150, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 50 }),
        new f({ h: 180, s: 33, v: 100 }),
        new f({ h: 180, s: 66, v: 100 }),
        new f({ h: 180, s: 100, v: 100 }),
        new f({ h: 180, s: 100, v: 75 }),
        new f({ h: 180, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 40 }),
        new f({ h: 210, s: 33, v: 100 }),
        new f({ h: 210, s: 66, v: 100 }),
        new f({ h: 210, s: 100, v: 100 }),
        new f({ h: 210, s: 100, v: 75 }),
        new f({ h: 210, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 30 }),
        new f({ h: 240, s: 33, v: 100 }),
        new f({ h: 240, s: 66, v: 100 }),
        new f({ h: 240, s: 100, v: 100 }),
        new f({ h: 240, s: 100, v: 75 }),
        new f({ h: 240, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 20 }),
        new f({ h: 270, s: 33, v: 100 }),
        new f({ h: 270, s: 66, v: 100 }),
        new f({ h: 270, s: 100, v: 100 }),
        new f({ h: 270, s: 100, v: 75 }),
        new f({ h: 270, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 10 }),
        new f({ h: 300, s: 33, v: 100 }),
        new f({ h: 300, s: 66, v: 100 }),
        new f({ h: 300, s: 100, v: 100 }),
        new f({ h: 300, s: 100, v: 75 }),
        new f({ h: 300, s: 100, v: 50 }),
        new f({ h: 180, s: 0, v: 0 }),
        new f({ h: 330, s: 33, v: 100 }),
        new f({ h: 330, s: 66, v: 100 }),
        new f({ h: 330, s: 100, v: 100 }),
        new f({ h: 330, s: 100, v: 75 }),
        new f({ h: 330, s: 100, v: 50 }),
        new f(),
      ],
    },
    images: {
